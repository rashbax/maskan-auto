...
const STR = {
  ru: {
    ...
    pernight: "за сутки", night_n: (n) => `${n} ${n === 1 ? "сутки" : "суток"}`, sleeps: (n) => `до ${n} гостей`,
    ...
    disc_line: (p) => `Бронь на сайте · −${p}%`, disc_save: (x) => `Вы экономите ${x}, бронируя на сайте`, disc_hint: (p) => `Бронируйте на сайте — на ${p}% дешевле, чем на других платформах.`, disc_badge: (p) => `−${p}% на сайте`,
    ...
    a_price: "Цена за сутки", a_save: "Сохранить", a_block: "Заблокировать", a_unblock: "Открыть", a_source: "Источник",
    ...
    src_website: "Сайт", src_booking: "Booking.com", src_manual: "Вручную", src_airbnb: "Airbnb", a_all: "Все", login: "Войти", password: "Пароль", admin_login: "Вход для хозяина",
    ...
    back: "Назад", mobile: "Телефон", desktop: "Десктоп", night1: "сутки",
  },
  en: {
    ...
    disc_line: (p) => `Direct booking · −${p}%`, disc_save: (x) => `You save ${x} by booking on the site`, disc_hint: (p) => `Book on the site — ${p}% cheaper than other platforms.`, disc_badge: (p) => `−${p}% on site`,
    ...
    src_website: "Website", src_booking: "Booking.com", src_manual: "Manual", src_airbnb: "Airbnb", a_all: "All", login: "Log in", password: "Password", admin_login: "Host login",
  ...
  uz: {
    ...
    pernight: "sutkasiga", night_n: (n) => `${n} sutka`, sleeps: (n) => `${n} kishigacha`,
    ...
    disc_line: (p) => `Saytdan bron · −${p}%`, disc_save: (x) => `Saytda bron qilib ${x} tejaysiz`, disc_hint: (p) => `Saytdan bron — boshqa platformalardan ${p}% arzon.`, disc_badge: (p) => `−${p}% saytda`,
    ...
    a_price: "Bir sutka narxi", a_save: "Saqlash", a_block: "Yopish", a_unblock: "Ochish", a_source: "Manba",
    ...
    src_website: "Sayt", src_booking: "Booking.com", src_manual: "Qoʻlda", src_airbnb: "Airbnb", a_all: "Hammasi", login: "Kirish", password: "Parol", admin_login: "Uy egasi kirishi",
    ...
    back: "Orqaga", mobile: "Telefon", desktop: "Kompyuter", night1: "sutka",
  },
};
