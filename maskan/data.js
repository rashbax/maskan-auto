...
const STR = {
  ru: {
    ...
    from: "Заезд", to: "Выезд", total: "Итого", nofees: "Без скрытых комиссий", service: "Сервисный сбор", cleaning: "Уборка",
    ...
    a_dashboard: "Сводка", a_today: "Заезды сегодня", a_upcoming: "Предстоящие", a_occupancy: "Загрузка", a_revenue: "Доход за месяц",
    ...
    src_website: "Сайт", src_booking: "Booking.com", src_manual: "Вручную", login: "Войти", password: "Пароль", admin_login: "Вход для хозяина",
    a_desc: "Описание", a_desc_ph: "Расскажите о квартире: район, вид, для кого подходит…",
    a_guests_field: "Сколько гостей", a_adults: "Взрослые", a_children: "Дети", a_beds: "Спальня", a_living: "Гостиная", a_baths: "Санузел", a_size: "Площадь, м²",
  ...
  en: {
    ...
    from: "Check-in", to: "Check-out", total: "Total", nofees: "No hidden fees", service: "Service fee", cleaning: "Cleaning",
    ...
    a_dashboard: "Dashboard", a_today: "Check-ins today", a_upcoming: "Upcoming", a_occupancy: "Occupancy", a_revenue: "Revenue this month",
    ...
    src_website: "Website", src_booking: "Booking.com", src_manual: "Manual", login: "Log in", password: "Password", admin_login: "Host login",
    a_desc: "Description", a_desc_ph: "Describe the flat: the area, the view, who it suits…",
    a_guests_field: "How many guests", a_adults: "Adults", a_children: "Children", a_beds: "Bedroom", a_living: "Living room", a_baths: "Bathroom", a_size: "Size, m²",
  ...
  uz: {
    ...
    from: "Kelish", to: "Ketish", total: "Jami", nofees: "Yashirin toʻlovlarsiz", service: "Xizmat haqi", cleaning: "Tozalash",
    ...
    a_dashboard: "Boshqaruv", a_today: "Bugungi kelishlar", a_upcoming: "Kelgusi", a_occupancy: "Bandlik", a_revenue: "Oylik daromad",
    ...
    src_website: "Sayt", src_booking: "Booking.com", src_manual: "Qoʻlda", login: "Kirish", password: "Parol", admin_login: "Uy egasi kirishi",
    a_desc: "Tavsif", a_desc_ph: "Kvartira haqida: hudud, manzara, kimga mos…",
    a_guests_field: "Necha mehmon", a_adults: "Kattalar", a_children: "Bolalar", a_beds: "Yotoqxona", a_living: "Mehmonxona", a_baths: "Hammom", a_size: "Maydon, m²",
